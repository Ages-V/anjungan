...
class DosenProfileTab extends StatelessWidget {
  final String uid;
  const DosenProfileTab({required this.uid});
              ...
              Container(
                ...
                child: Column(
                  children: [
                    ...
                    SizedBox(height: 15),
                    Text(data['nama'] ?? "Dosen", style: TextStyle(fontFamily: 'Poppins', fontSize: 22, fontWeight: FontWeight.bold)),
                    Text(data['email'] ?? "-", style: TextStyle(fontFamily: 'Poppins', fontSize: 14, color: Colors.grey)),
                    SizedBox(height: 10),
                    Container(
                      padding: EdgeInsets.symmetric(horizontal: 12, vertical: 4),
                      decoration: BoxDecoration(color: Colors.blue.shade50, borderRadius: BorderRadius.circular(20)),
                      child: Text("Dosen Pembimbing", style: TextStyle(color: Colors.blue, fontSize: 11, fontFamily: 'Poppins')),
                    )
                  ],
                ),
              ),
